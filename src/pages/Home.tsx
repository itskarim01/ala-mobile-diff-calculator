  ...
  return (
    <div>
      ...
      <div style={{ textAlign: "center", margin: "30px" }}>
        <p className="text-lg w-1/2 ml-auto mr-auto max-md:text-md">
        ...
        <p className="mt-3 mb-5 text-lg text-gray-500 max-md:text-sm">
          Select a track to get your difficulty:
        </p>
        <section className="grid grid-cols-4 max-md:grid-cols-3 gap-3">
            ...
            return (
              ...
              >
                <CountryFlag
                  ...
                  svg
                  className="w-12 max-md:w-6 max-sm:w-4 h-fit border-2 rounded-2xl"
                />
                {capitalize(track)}
              </Link>
            );

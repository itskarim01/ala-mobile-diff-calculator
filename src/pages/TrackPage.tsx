  ...
  return (
    <div>
      ...
      <section className="text-center mt-3 md:mt-10 px-2 w-full max-w-2xl mx-auto">
        ...
        />
        <br/>
        <button className="p-2 border-accent text-lg rounded-2xl mt-3 md:mt-5 font-semibold transition-all duration-250 text-white bg-accent hover:bg-white hover:text-accent w-full max-w-xs" onClick={calculate}>Calculate</button>
      </section>
    </div>
  );
}
